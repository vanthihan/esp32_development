...
typedef int32_t (*stmdev_write_ptr)(uint8_t, uint8_t, uint8_t *, uint32_t);
typedef int32_t (*stmdev_read_ptr)(uint8_t, uint8_t, uint8_t *, uint32_t);
